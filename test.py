...
urban_l = v2light_pollution(10,10,8,10,6,[[7,5,10,10,9]])
suburban_l = v2light_pollution(7,5,10,10,9,[[10,10,8,10,6],[2,1,3,10,10]])
rural_1 = v2light_pollution(2,1,3,10,10,[[10,10,8,10,6],[.1,0,1,10,7]])
protected_1 = v2light_pollution(0.1,0,1,10,7,[[2,1,3,10,10]])

print("Urban risk with area=1 ",calc_risk(urban_l))
print("suburban risk with area=1 " ,calc_risk(suburban_l))

urban = [10,10,8,10,6,urban_l,calc_risk(urban_l)]
suburban = [7,5,10,10,9,suburban_l,calc_risk(suburban_l)]
